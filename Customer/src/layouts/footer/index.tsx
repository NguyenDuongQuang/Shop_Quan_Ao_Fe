...
function Footer() {
  return (
    <div className="bg-slate-800 py-14" id="footer">
      <div className="mx-auto max-w-7xl px-6 sm:px-6 lg:px-8 ">
        <footer className="bg-slate-800 p-4 sm:p-6 ">
          <div className="md:flex md:justify-between">
            {/* <div className="mb-6 md:mb-0">
              <Link to={"#"} target="_blank" className="flex items-center">
                <img
                  src={"http://fusamate.site/static/7a9a83eb9b6742391b76.jpg"}
                  className="mr-4 h-11"
                  alt="flowbite Logo"
                />
              ...
              <div>
                ...
                <ul>
                  <li className="mb-4">
                    ...
                    >
                      HUB Hà Nội: Tầng 3-4, Tòa nhà BMM,
                      <br />
                      KM2, Đường Phùng Hưng,
                      <br />
                  ...
                  {/* <li className="mb-4 text-sm">
                      ...
                      HUB Hà Nội: Tầng 3-4, Tòa nhà BMM, KM2, Đường Phùng Hưng, Phường Phúc La, Quận Hà Đông, TP Hà Nội
